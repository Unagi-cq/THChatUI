...
2. （使用者友好）远程第三方请求：仅需要去第三方申请KEY填入“系统设置”——“API KEY”中。本项目永久开放讯飞星火Spark Lite模型调用，并支持阿里云百炼、智谱AI平台的大部分模型的远程调用。

### 在线体验与代码仓库
[THChatUI在线体验版](http://localchatui.wuxitianyouqi.com/#/)
> 【注1】THChatUI在线体验版只提供了讯飞星火Lite模型调用，阿里云百炼、智谱AI平台的模型调用需要去对应平台申请Key并填入设置中，Key只会保存在本地浏览器缓存中，绝对安全。
