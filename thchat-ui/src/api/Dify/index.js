...
export async function fetchAPI({
    ...
    const { base_url, api_key, type } = model_config;

    const url = base_url + (API_URLS[type] || API_URLS.llm);
    ...
    const requestConfig = {
        ...
        body: JSON.stringify(preProcess(undefined, prompt, history, type, files, is_search)),
